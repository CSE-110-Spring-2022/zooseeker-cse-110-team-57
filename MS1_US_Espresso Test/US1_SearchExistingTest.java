...
public class US1_SearchExistingTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void searchExistingTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.an_animal_from_search), withText("Lions"),
                        withParent(withParent(withId(R.id.all_searched_animals))),
                        isDisplayed()));
        ...
        ViewInteraction searchAutoComplete3 = onView(
                allOf(withId(androidx.appcompat.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete3.perform(replaceText("gorillas"), closeSoftKeyboard());

        ViewInteraction textView2 = onView(
                allOf(withId(R.id.an_animal_from_search), withText("Gorillas"),
                        withParent(withParent(withId(R.id.all_searched_animals))),
                        isDisplayed()));
