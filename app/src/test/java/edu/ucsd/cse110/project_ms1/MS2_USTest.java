...
public class MS2_USTest {
    ...
    @Rule
    public ActivityScenarioRule<DirectionActivity> scenarioRule = new ActivityScenarioRule<>(DirectionActivity.class);
    ...
    public void dir_clear(){
        ActivityScenario activityScenario = scenarioRule.getScenario();
